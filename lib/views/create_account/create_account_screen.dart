                          ...
                          if (cubit.loginType == LoginType.phone)
                            CommonTextFormField(
                              ...
                              validator: (value) {
                                ...
                                if (phone.length != cubit.phoneMaxLength) {
                                  return "Please enter a valid mobile number";
                                }
                                return null;
                              },
                              ...
                              children: [
                                ...
                                CommonTextFormField(
                                  ...
                                  validator: (value) {
                                    if (value == null || value.trim().isEmpty) {
                                      return "Required*";
                                    } else if (!cubit.passwordController.text.equalsIgnoreCase(value)) {
                  ...
                  CommonButton(
                    onTap: () {
                      if (cubit.formKey.currentState!.validate()) {
                        if (!cubit.isAgeSelected) {
                          showToast(isError: true, message: "Please agree to the age requirement");
                          return;
                        }
                        if (!cubit.isTermsSelected) {
                          showToast(
                            isError: true,
