                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  CommonText(text: item, fontSize: size(context).width * numD04),
                                  CommonText(
                                    text:
                                        "Hop lightly on your supporting leg while moving your dominant foot around the ball in an outward circle, keeping contact as smooth as possible.",
                                    color: Colors.grey,
                                    fontSize: size(context).width * numD035,
                                  ),
                                ],
